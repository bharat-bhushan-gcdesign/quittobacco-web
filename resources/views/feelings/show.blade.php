...
<div id="content" class="bg-container">
    ...
    <div class="row">
        ...
        <!-- <div class="col-sm-8 input_field_sections" >
            <input type="checkbox" data-toggle="toggle" data-on="Click to Un Verify" data-off="Click to Verify" data-onstyle="success" data-offstyle="danger" data-size="mini" class="statuschange" id="{{$feeling->id}}" @if($feeling->status ==1) checked='checked' @endif>
        </div> -->
    </div>
    <div class="outer">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-4 input_field_sections">
                                    <h4>Description</h4>
                                    <strong>{{$feeling->description}} </strong>
                                </div>
                            </div>
