...
<div id="content" class="bg-container">
    ...
    <div class="row">
        ...
        <!-- <div class="col-sm-8 input_field_sections" >
            <input type="checkbox" data-toggle="toggle" data-on="Click to Verify" data-off="Click to Un Verify" data-onstyle="success" data-offstyle="danger" data-size="mini" class="statuschange" id="{{$subscription->id}}" @if($subscription->status ==1) checked='checked' @endif>
        </div> -->
    </div>
    <div class="outer">
