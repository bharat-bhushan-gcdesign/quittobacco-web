                                ...
                                <div class="card-body m-t-35">
                                    <div class="row">
                                        <div class="col-sm-3">  <div class="btn-group show-hide">
                                              ...
                                              <a data-toggle="tooltip" data-placement="top" title="Add"  class="btn btn-primary"  href="{{url('cms/create')}}" > <i class="fa fa-plus"></i> </a>
                                        ...
                                        <tbody>
                                          @foreach($cms as $val)
                                            <tr>
                                                ...
                                                <td class="nowrap">
                                                <a data-toggle="tooltip" data-placement="top" title="Edit" href="{{url('cms/edit',['id' => $val->id])}}" class="btn btn-primary btn-xs">
