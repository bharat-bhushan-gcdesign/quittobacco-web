        ...
        <div id="content" class="bg-container">
                   ...
                   <div class="row no-gutters">
                       ...
                       <div class="col-sm-7 col-lg-6">
                           <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                               ...
                               <li class="breadcrumb-item">
                                   <a href="{{url('/subscription_mangement')}}">Subscription Management</a>
                               </li>
            ...
            <div class="outer">
                <div class="inner bg-container forms">
                    <form method="POST" action="{{url('subscription_mangement/save')}}" id="adforms" name="edit_country" class="form-horizontal">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                       ...
                                       <div class="col-sm-9 input_field_sections">                                       
                                           <input type="text" class="form-control" name="name" id="name" value="{{ ( isset($quitReason->title) ? $quitReason->title : null) }}" placeholder="Enter Title here.." minlength="1" maxlength="50" onkeypress="return lettersOnly(event)" />  
                                  ...
                                  <div class="row">
                                       ...
                                       <div class="col-sm-9 input_field_sections">                                       
                                           <input type="text" class="form-control" name="price" id="price" value="{{ ( isset($quitReason->price) ? $quitReason->price : null) }}" placeholder="Enter Price here.." minlength="1" maxlength="50" />  
   ...
   $( "#adforms" ).validate({
      ...
      rules: {    
        name: {
            ...
            maxlength:50,
            remote: {
                    url: "/subscription_mangement/check-Title",
                    type: "post",
                    data: {
                        name: function() {
                            return $( "#name" ).val();
...
$("#cancelform").click(function() {
   window.location.href = "{{url('/subscription_mangement')}}";
});
