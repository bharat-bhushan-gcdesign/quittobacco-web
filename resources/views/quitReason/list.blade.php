                                ...
                                <div class="card-body m-t-35">
                                    <div class="row">
                                        <div class="col-sm-3">  <div class="btn-group show-hide">
                                              ...
                                              <a data-toggle="tooltip" data-placement="top" title="Add"  class="btn btn-primary"  href="{{url('reasonsToQuit/create')}}" > <i class="fa fa-plus"></i> </a>
                                        ...
                                        <tbody>
                                          @foreach($quitReason as $k=>$val)
                                            <tr>
                                                ...
                                                <td class="nowrap">
                                                <a data-toggle="tooltip" data-placement="top" title="Edit" href="{{url('reasonsToQuit/edit',['id' => $val->code])}}" class="btn btn-primary btn-xs">
                                                <i class="fa fa-pencil"></i>
                                                </a>
                                                <a data-toggle="tooltip" data-placement="top" title="View" href="{{url('reasonsToQuit/view',['id' => $val->code])}}" class="btn btn-info btn-xs">
                                                <i class="fa fa-eye"></i>
                                                </a>
    ...
    $(".successmsg").hide()
     ...
     $('body').on('change', '.statuschange', function() {
      ...
      var status = $(this).prop('checked');
        $.ajax({
        type : "POST",
        url : "{{ url('/') }}/reasonsToQuit/statusupdate",
