                                ...
                                <div class="card-body m-t-35">
                                    <div class="row">
                                        <div class="col-sm-3">  <div class="btn-group show-hide">
                                              ...
                                              <a data-toggle="tooltip" data-placement="top" title="Add"  class="btn btn-primary"  href="{{url('specialist/create')}}" > <i class="fa fa-plus"></i> </a>
                                          ...
                                          @foreach($eventpayment as $k=> $val)
                                            <tr>
                                             <td> {{$k+1}}</td>
                                                ...
                                                <td class="nowrap">
                                                <a data-toggle="tooltip" data-placement="top" title="Edit" href="{{url('specialist/edit',['id' => $val->id])}}" class="btn btn-primary btn-xs">
                                                <i class="fa fa-pencil"></i>
                                                </a>
                                               <a data-toggle="tooltip" data-placement="top" title="View" href="{{url('specialist/view',['id' => $val->id])}}" class="btn btn-info btn-xs">
                                                <i class="fa fa-eye"></i>
                                                </a>
                                                 <a href="#" class="btn btn-danger btn-xs waves-effect waves-light remove-record" data-toggle="modal" data-url="{{URL::to('/specialistdestroy/'.$val->id) }}" data-id="{{$val->id}}" data-target="#custom-width-modal" title="Delete" data-placement="top">
    ...
    $(".successmsg").hide()
     ...
     $('body').on('change', '.statuschange', function() {
      ...
      var status = $(this).prop('checked');
        $.ajax({
        type : "POST",
        url : "{{ url('/') }}/specialist/statusupdate",
