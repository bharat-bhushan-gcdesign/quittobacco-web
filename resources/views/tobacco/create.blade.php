            ...
            <div class="outer">
                <div class="inner bg-container forms">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <form method="POST" action="{{url('tobacco/savetitle')}}" id="titleforms" name="edit_country" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                                          {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="row">
...
$("#cancelform").click(function() {
       window.location.href = "{{url('/tobacco')}}";
   }); 
