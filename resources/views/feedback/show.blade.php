...
<div id="content" class="bg-container">
            ...
            <div class="row no-gutters">
                ...
                <div class="col-sm-7 col-lg-6">
                    <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                        ...
                        <li class="breadcrumb-item">
                           <a href="/service-provider-verifications">Feedback</a>
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <!-- <div class="col-sm-8 input_field_sections" >
            <input type="checkbox" data-toggle="toggle" data-on="Click to Verify" data-off="Click to Un Verify" data-onstyle="success" data-offstyle="danger" data-size="mini" class="statuschange" id="{{$feedback->id}}" @if($feedback->status ==1) checked='checked' @endif>
        </div> -->
    </div>
    <div class="outer">
