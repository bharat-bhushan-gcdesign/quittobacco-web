    ...
    top: 15px;">Past Orders</h2>
            ...
            <tr style="text-align: center;display: block; ">
               <td style="width: 100%;float: left;   margin: 10px auto 30px;">
                  <h4 style="border: 1px solid #ddd; display: inline-block;  padding: 10px 30px; border-radius: 30px; color: #fff;"> File attached</h4>
                  
               </td>
            </tr>
            <tr   style="text-align: center;display: block; margin-left:40%;" >
            <td >
             <!--   <a href="http://avi.dci.in" style="color: #d0d0d0;">Click to view website</a> -->
            </td>
            </tr>
