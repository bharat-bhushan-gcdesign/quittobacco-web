        ...
        <div id="content" class="bg-container">
            ...
            <div class="outer">
                <div class="inner bg-container forms">
                    <form method="POST" action="{{url('customMessage/save')}}" id="adforms" name="edit_country" class="form-horizontal">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                       ...
                                       <div class="col-sm-9 input_field_sections">                                       
                                           <input type="text" class="form-control" name="name" id="name" value="{{ ( isset($customMessage->title) ? $customMessage->title : null) }}" placeholder="Enter Title here.." minlength="1" maxlength="50" onkeypress="return lettersOnly(event)"/>  
                                     ...
                                     <div class="row">
                                      <div class="col-sm-3 input_field_sections">
                                       ...
                                       <div class="col-sm-9 input_field_sections">                                        
                                           <textarea name="description" id="description" class="form-control">{{ ( isset($customMessage->description) ? base64_decode($customMessage->description) : null) }}</textarea>
                                        </div>
                                    ...
                                    <div class="row"> 
                                       <div class="col-sm-3 input_field_sections">
                                        ...
                                        <div class="col-sm-9 input_field_sections">
                                             ...
                                             <option value="0" {{ (isset($customMessage->status) && $customMessage->status==0)  ? 'selected': '' }}>InActive</option>
                                             </select>
                                        </div>
                                    </div>  
...
$("#cancelform").click(function() {
   window.location.href = "{{url('/customMessage')}}";
});
