                                ...
                                <div class="card-body m-t-35">
                                    <div class="row">
                                        <div class="col-sm-3">  <div class="btn-group show-hide">
                                              ...
                                              <a data-toggle="tooltip" data-placement="top" title="Add"  class="btn btn-primary"  href="{{url('customMessage/create')}}" > <i class="fa fa-plus"></i> </a>
                                   ...
                                   <div class=" m-t-15">
                                    <table class="table table-striped table-bordered table_res toggle_class" id="sample_6">
                                        ...
                                        <tbody>
                                          @foreach($customMessage as $k=>$val)
                                            <tr>
                                                <td>{{$k+1}}</td>
                                                ...
                                                <td class="nowrap">
                                                <a data-toggle="tooltip" data-placement="top" title="Edit" href="{{url('customMessage/edit',['id' => $val->id])}}" class="btn btn-primary btn-xs">
                                                <i class="fa fa-pencil"></i>
                                                </a>
                                                <a data-toggle="tooltip" data-placement="top" title="View" href="{{url('customMessage/view',['id' => $val->id])}}" class="btn btn-info btn-xs">
                                                <i class="fa fa-eye"></i>
                                                </a>
    ...
    $(".successmsg").hide()
     ...
     $('body').on('change', '.statuschange', function() {
      ...
      var status = $(this).prop('checked');
        $.ajax({
        type : "POST",
        url : "{{ url('/') }}/customMessage/statusupdate",
