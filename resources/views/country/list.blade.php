                                ...
                                <div class="card-body m-t-35">
                                    <div class="row">
                                        <div class="col-sm-3">  <div class="btn-group show-hide">
                                              ...
                                              <a data-toggle="tooltip" data-placement="top" title="Add"  class="btn btn-primary"  href="{{url('country/create')}}" > <i class="fa fa-plus"></i> </a>
                                        ...
                                        <tbody>
                                          @foreach($country as $val)
                                            <tr>
                                                ...
                                                <td class="nowrap">
                                                <a data-toggle="tooltip" data-placement="top" title="Edit" href="{{url('country/edit',['id' => $val->id])}}" class="btn btn-primary btn-xs">
                                                <i class="fa fa-pencil"></i>
                                                </a>
                                                <!-- <a data-toggle="tooltip" data-placement="top" title="View" href="{{url('country/view',['id' => $val->id])}}" class="btn btn-info btn-xs">
                                                <i class="fa fa-eye"></i>
                                                </a> -->
                                                 <a href="#" class="btn btn-danger btn-xs waves-effect waves-light remove-record" data-toggle="modal" data-url="{{URL::to('/countrydestroy/'.$val->id) }}" data-id="{{$val->id}}" data-target="#custom-width-modal" title="Delete" data-placement="top">
