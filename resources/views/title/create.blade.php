            ...
            <div class="outer">
                <div class="inner bg-container forms">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <form method="POST" action="{{url('title/savetitle')}}" id="titleforms" name="edit_country" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                                          {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="row">
                                       ...
                                       <div class="col-sm-6 input_field_sections">
                                            <h5>Title </h5>
                                           <input type="text" class="form-control" name="name" id="name" value="{{ old('name', isset($title->name) ? $title->name : null) }}" placeholder="Enter Title here.." minlength="1" maxlength="30"  onkeypress="return lettersOnly(event)"/>
                                       ...
                                       <div class="col-sm-6 input_field_sections">
                                          <h5>Status</h5>
                                             ...
                                             <option value="0" {{ (isset($title->status) && $title->status==0)  ? 'selected': '' }}>InActive</option>
                                             </select>
                                        </div> 
