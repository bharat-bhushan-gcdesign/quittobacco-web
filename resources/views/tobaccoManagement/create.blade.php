                   ...
                   <div class="row no-gutters">
                       <div class="col-sm-5 col-lg-6 skin_txt">
                           <h4 class="nav_top_align">
                               ...
                               @if($pid=="")
                                Add Tobacco Management
                               @else
                                Edit Tobacco Management
                               @endif
                           </h4>
                       </div>
                       <div class="col-sm-7 col-lg-6">
                           <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                               ...
                               <li class="breadcrumb-item">
                                   <a href="{{url('/tobacco_management')}}">Tobacco</a>
                               </li>
            ...
            <div class="outer">
                <div class="inner bg-container forms">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <form method="POST" action="{{url('tobacco_management/savetitle')}}" id="titleforms" name="edit_country" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                                          {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="row">
                                       ...
                                       <div class="col-sm-6 input_field_sections">
                                            <h5>Name </h5>
                                           <input type="text" class="form-control" name="name" id="name" value="{{ old('name', isset($tobacco->name) ? $tobacco->name : null) }}" placeholder="Enter Name here.." minlength="1" maxlength="30"  onkeypress="return lettersOnly(event)"/>
...
$("#cancelform").click(function() {
       window.location.href = "{{url('/tobacco_management')}}";
   }); 
