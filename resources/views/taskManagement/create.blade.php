        ...
        <div id="content" class="bg-container">
                   ...
                   <div class="row no-gutters">
                       ...
                       <div class="col-sm-7 col-lg-6">
                           <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                               ...
                               <li class="breadcrumb-item">
                                   <a href="{{url('/task_management')}}">Task Management</a>
                               </li>
            ...
            <div class="outer">
                <div class="inner bg-container forms">
                    <form method="POST" action="{{url('task_management/save')}}" id="adforms" name="edit_country" class="form-horizontal">
                    <div class="row">
                        <div class="col">
                            <div class="card">
   ...
   $( "#adforms" ).validate({
      ...
      rules: {    
        name: {
            ...
            maxlength:50,
            remote: {
                    url: "/task_management/check-Title",
                    type: "post",
                    data: {
                        name: function() {
                            return $( "#name" ).val();
...
$("#cancelform").click(function() {
   window.location.href = "{{url('/task_management')}}";
});
