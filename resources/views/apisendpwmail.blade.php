...
<html lang="en-US" class="no-js no-svg">
   ...
   <body style="height: 100%;margin: 0 auto;font-family: 'Roboto', sans-serif;background:#f8f9fa;display: block;width: 100%; background-color: #fff !important;">
      ...
      <table style="margin:50px auto; width:50%;background-color: #ed7626;border-radius: 0px;">
         <thead>
            <th >
               <h1 style="font-size: 40px;font-weight: bold;color:#fff;text-transform: uppercase;">Buskerr</h1>
            </th>
    ...
    top: 15px;">Your New Password </h2>
            ...
            <td >
         <!--  <p style="font-size: 16px;font-weight: bold;color: #fff;">You received this email because you received password for AVI.</p> -->
            </td>
            </tr>
         </tbody>
      </table>
