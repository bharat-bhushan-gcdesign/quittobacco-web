                                ...
                                <div class="card-body m-t-35">
                                    <div class="row">
                                        <div class="col-sm-3">  <div class="btn-group show-hide">
                                              ...
                                              <a data-toggle="tooltip" data-placement="top" title="Add"  class="btn btn-primary"  href="{{url('faq/create')}}" > <i class="fa fa-plus"></i> </a>
                                   ...
                                   <div class=" m-t-15">
                                    <table class="table table-striped table-bordered table_res toggle_class" id="sample_6">
                                        ...
                                        <tbody>
                                          ...
                                          <!--       <td> {{$val->question}}</td> -->
                                                  <td> <?php $datas=strip_tags(base64_decode($val->question))?>
                                                 {!!str_limit($datas,25)!!}
                                                </td>
                                                 <td> <?php $datas=strip_tags(base64_decode($val->description))?>
                                                 {!!str_limit($datas,25)!!}
                                                </td>
                                                ...
                                                <td class="nowrap">
                                                <a data-toggle="tooltip" data-placement="top" title="Edit" href="{{url('faq/edit',['id' => $val->id])}}" class="btn btn-primary btn-xs">
                                                <i class="fa fa-pencil"></i>
                                                </a>
                                                <a data-toggle="tooltip" data-placement="top" title="View" href="{{url('faq/view',['id' => $val->id])}}" class="btn btn-info btn-xs">
                                                <i class="fa fa-eye"></i>
                                                </a>
                                                <a href="#" class="btn btn-danger btn-xs waves-effect waves-light remove-record" data-toggle="modal" data-url="{{URL::to('/faqdestory/'.$val->id) }}" data-id="{{$val->id}}" data-target="#custom-width-modal">
