            ...
            <div class="row no-gutters">
                ...
                <div class="col-sm-7 col-lg-6">
                    <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                        ...
                        <li class="breadcrumb-item">
                           <a href="{{route('user_details.index')}}">User Details</a>
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 input_field_sections">
                                    @if($user->profile_image!=null)
                                        <img src="{{url('/')}}/uploads/userimage/{{$user->profile_image}}" id="profile-img-tag" width="180px" height="140px"  name="profile_imaged" style="margin-top:15px;"/>
                                    @else
                                ...
                                <div class="col-sm-4 input_field_sections">
                                    ...
                                    @if($user->userSaving!=null)
                                        <strong>Per Day -{{$user->userSaving->per_day}},</strong>
                                        <strong> Per Week -{{$user->userSaving->per_week}},</strong>
                                        <strong> Per Month -{{$user->userSaving->per_month}},</strong>
                                        <strong> Per Year -{{$user->userSaving->per_year}}.</strong>
                                    @else
                                        Not yet saved anything
                                    @endif
