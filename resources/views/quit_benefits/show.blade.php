...
<div id="content" class="bg-container">
    ...
    <div class="row">
        ...
        <div class="col-sm-8 input_field_sections" >
            <input type="checkbox" data-toggle="toggle" data-on="Click to Un Verify" data-off="Click to Verify" data-onstyle="success" data-offstyle="danger" data-size="mini" class="statuschange" id="{{$quit_benefit->id}}" @if($quit_benefit->status ==1) checked='checked' @endif>
        </div>
    </div>
    <div class="outer">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-4 input_field_sections">
                                    <h4>Description</h4>
                                    <strong>{{$quit_benefit->description}} </strong>
                                </div>
                                <div class="col-sm-4 input_field_sections">
                                    <h4>Image</h4>
                                    
                                    @if($quit_benefit->file!=null)
                                        <img src="{{url('/')}}/uploads/files/{{$quit_benefit->file->name}}" id="profile-img-tag" width="180px" height="140px"  name="content"/>
                                    @else
                                        <img src="{{url('/')}}/defaults/default.jpg" id="profile-img-tag" width="180px" height="140px" name="profile_imaged" />
                                    @endif
                                </div>
                            </div>
